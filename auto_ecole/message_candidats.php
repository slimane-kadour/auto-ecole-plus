...
<body>
	        ...
	        <div class="inside">
				...
				<div id="navigationheader">
                    <ul>
						...
						<li><a id="navsuggestion" href="message_candidats.php">Faire une remarque</a></li>
					</ul>
                </div>
				<!--   <div class="image_candidat2">    <a href="Date_examen.php?idPersonne=<?php echo  $id ; ?>#ancre" ><img src="images/400_F_46158897_sI930mneSVV7y2YwZ7eXk7UNz8KuvY8e.jpg"/>  </div>-->
 ...
 if( $result = mysql_fetch_object( $requete ) )
				...
				<div id="introduction">
                    <p>
						<strong><?php echo ($result->nom." ".$result->prenom.".");?></strong> Si vous avez des remarques, suggestion, ou des questions n'hésitez pas à nous contactez.
					</p>
                </div>
				<?php } ?>
<div id="content">
...
<div id="contentsection">
	...
	<div id="suggestion">
		...
		<p>
			Vous avez des questions , des suggestion , n'hésitez paq à nous contactez .
		
		</p>

		<form action="add_message_direction2.php" method="post" id="formsuggestion" onsubmit="return dbck.validate();">
