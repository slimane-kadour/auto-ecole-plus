...
<body>
  ...
  <div class="main-box">
                    ...
                    <section id="espPerso" class="bloc">
			            ...
			            <?php } else{ ?>
						<p class="erreur"> Vos nouveaux mots de passe sont differents </p>
	                    <h3><a href="deconnexion.php">Déconnexion</a></h3>
						<h3><a href="#?w=500" rel="popup_name2" class="poplight">Réessayer ?</a></h3>
...
<div id="contentsection">
		...
		<p>
			Les jours de travails :  </br>    14/05/2014 ==> de 15h00 à 16h00</br>
		                                  18/05/2014 ==> de 15h00 à 16h00 
