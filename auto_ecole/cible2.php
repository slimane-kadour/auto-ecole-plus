...
<body>
			...
			<p><img src="<?php echo "images/".$_SESSION['$h'];?>" width="146" height="167"/></p>
									...
									<div id="apDiv2">
										...
										<p><?php echo $_SESSION['$num_dipl']; ?></p>
