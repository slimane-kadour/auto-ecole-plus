    ...
    <div class="container">
      ...
      <div class="inside">
	   <div class="wrapper">
        ...
        <section id="content">
		    <article>
			<div class="bloc-contenu" id="ancre3">
				<div class="clearover">
		...
		<div class="ajouter">
					<form method="post" action="add_article.php">
						   ...
						   <input type="text" name="titre_article" required="required"/>
						  
						   <label>Votre Nom :</label>
						   <input type="text" name="membre_article"  required="required"/>
						  
						   <label>Votre Article : </label>
						   <textarea rows="5" cols="20" name="corps_article" required="required"></textarea>
						  
						   <input type="submit" value="poste" name="submit"/>
