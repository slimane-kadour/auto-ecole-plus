	        ...
	        <div class="inside">
	  	        <div class="wrapper2">
                    ...
                    <section id="content">
                        ...
                        <article>
						 <h2 align="center"> Les Messages Reçus </h2>  </br>
			               <?php 
			try
{
...
$reponse = $bdd->query('SELECT * FROM message_direction ORDER BY heure_message DESC');
			?>
			    ...
			    <table cellspacing='0' > 
                    ...
                    <tr class='even'>
						...
						<td><?php echo $donnees['Titre_message']; ?></td>
						<td><?php echo $donnees['Contenu_message']; ?></td>
						<td><?php echo $donnees['Date_message']; ?></td>
						<td><a href="envoyer_message.php?idPersonne=<?php echo $donnees['Email']; ?>"><img src="images/mail.jpg"/></a></td>
						<td><a href="supprimer_message.php?idPersonne=<?php echo $donnees['id_Message']; ?>"
						onClick="return confirm('Voulez vous vraiment supprimer ce message?');"><img src="images/corbeille.png"/></a></td>
					</tr>
