  ...
  <div class="main-box" >
    <!-- #gallery --> 
                    ...
                    <section id="espPerso" class="bloc">
			            ...
			            <?php } else{   ?>
						<p class="erreur"> Vous avez un nouveau mot de passe  </p>
        ...
        <div class="container">
	        <div class="inside">
				...
				<div id="navigationheader">
                    <ul>
						<li><a id="navinformation" href="coordone.php">Information</a></li>
	  	        ...
	  	        <div class="wrapper2" id="ancre">
                    ...
                    <section id="content">
		                ...
		                <article>
	                 <div id="apDiv11">
                       <a href="Date_examen.php#ancre"><img src="images/agenda.jpg" width="300" height="320"/> </a>
                        </div>
...
//requête SQL:
  ...
  //exécution de la requête:
  $requete2 = mysql_query( $sql, $cnx ) ;
 if( $result2 = mysql_fetch_object( $requete2 ) )
								  { ?>
								  <p>
		    Envoyer le : <?php echo($result2->date_denvoie ) ;?></br>
			Epreuve :<?php echo($result2->epreuve) ;?></br>
			Résultat : <?php echo($result2->resultat_examen) ;?></br>
			Examen payer ? : <?php echo($result2->examen_payer) ;?></br>
			Remarque :<?php echo($result2->remarque) ;?></br>
		</p>   
	...
	Vous n'avez pas encore passer l'examen  
		</p>
		<?php 
		}   ?>
...
<div id="contentsectionleft">
	...
	<div id="history">
		...
		<p>
			 <strong>Type de permis :</strong><?php echo($result->type_permis) ;?>
			
		</p>
            
		<p>
			<strong>Date de début de cours :</strong><?php echo($result->date_debut_cours) ;?>
		</p>
		<?php 
...
<div id="contentsectionright">
	...
	<div id="staff">
		...
		<div class="member">
			...
			<img src="<?php echo "images/".$result->foto;?>" width="120" height="140" border="" />

			<div class="nom_adresse"><h3><?php echo ($result->nom." ".$result->prenom.".");?></h3>

			<h4><?php echo($result->adresse) ;?></h4></div>
