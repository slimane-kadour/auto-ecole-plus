        ...
        <div class="container">
	        ...
	        <div class="inside">
												...
												<section id="espPerso3" class="bloc">
													...
													<p><span><?php echo $_SESSION['$nom']." ".$_SESSION['$prenom'];  ?></span></br> à été ajouter avec succes
													sous le Numéro d'inscription:<span><?php echo $_SESSION['$num']; ?><span></p>
													<a href="cible.php"> Voir le formulaire >> </a>
												</section>
                    ...
                    <section id="content">
						 ...
						 <article>
							...
							<form action="add_member.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label for="date3"><strong>Date du début de cours : </strong></label>
			                            <input id="date3" name="date3" type="date"  required="required" /> 
											
										<label for="total"><strong>Prix total : </strong></label> 
