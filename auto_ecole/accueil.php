                    ...
                    <?php if (!isset($_SESSION['connect'])){?>
						...
						<section id="authent">
						    <form  method="post" action="connect.php">
						        <p><label for="pseudo"> Votre Nom :</label><br/>
							    <input type="text" name="pseudo"  id="pseudo"  required="required"/></p>
						        <p><label for="password">Mot de passe :</label><br/>
						        <input type="password" name="password"  id="password" required="required"/></p>
						        <input type="submit" value="Connexion" name="submit" class="submitOk" />
                            </form>
						</section>
