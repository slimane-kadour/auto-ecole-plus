							...
							<div class="container2">
								...
								<nav>
									<ul>
										...
										<li><a href="Nos Service.php#ancre">Nos Service</a></li>
 ...
 if( $result = mysql_fetch_object( $requete ) )
  ...
  <section id="espPerso" class="bloc">
    ...
    <div class="container">
      <div class="inside">
        <div class="wrapper">
		<div class="paragraphe"><p> Message Envoyer </p></div>
        	<!-- aside -->
          <aside>
            <!-- .contacts -->
            <ul class="contacts">
              ...
              <li><strong>Email:</strong><a href="#">auto-école-plus@mail.com</a></li>
            </ul>
            <!-- /.contacts -->
