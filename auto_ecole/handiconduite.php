  ...
  <section id="espPerso" class="bloc">
		...
		<div id='cssmenu'>
                <ul>
                  ...
                  <li><a href='handiconduite.php'  class="current2"><span>Handi'conduite</span></a></li>
                 </ul>
             </div>
			 </br> </br>
       ...
       <a href="code_de_rote.pdf"><img src="images/3801.jpg" alt=""   width="230" height="300" align="left"/></a> 
	    <a href="http://www.preventionroutiere.asso.fr/Espace-multimedia/Tests-Code-de-la-route"><img alt="" src="images/896805111.jpg" width="230" height="300" align="left" class="quiz"></a>
                  ...
                  <div class="imgleft" style="max-width: 100%;width:150px;">
                    <img src="images/handi-permis.jpg" alt="" style="width: 100%"/></div>
                        <strong><a href="#principe">1.&nbsp;Principe</a><br />  
				        <a href="#condition"> 2.&nbsp;Conditions d'inscription</a><br />  
				        <a href="#aménagement"> 3.&nbsp;Aménagement des épreuves pour les candidats sourds ou malentendants</a><br />  
				        <a href="#validité">  4.&nbsp;Durée de validité du permis</a><br /> 
				  </div>
			     </div>     
<div id="contenu">
          <h3>
		    1.  Principe <a name="principe" id="principe"></a></h3>
		<p> Une personne handicapée physique peut conduire un véhicule de catégorie B ou E(B), spécialement aménagé pour tenir compte de son
		infirmité. Elle doit avoir obtenu au préalable le permis de conduire de la catégorie visée.
		</p>
		<div class="hr"></div>
		<h3>
		    2. Conditions d'inscription<a name="condition" id="condition"></a></h3>
			<p> Le candidat peut se présenter aux épreuves du permis : </br>
			* s'il a l'âge requis</br>
			* s'il a été reconnu apte par la commission médicale départementale</br>
			Aux véhicules de cette catégorie peut être attelée une remorque : </br>
			Le candidat doit être âgé : </br>
			* de 16 ans minimum pour les catégories A1 et B1</br>
			* de 17 ans et demi (épreuve théorique) et de 18 ans (épreuve pratique) pour les permis A et B </br>
			...
			<div class="hr"></div>
			<h3>
		    3. Aménagement des épreuves pour les candidats sourds ou malentendants<a name="aménagement" id="aménagement"></a></h3>
			<p> Des sessions spécialisées sont prévues pour les candidats sourds ou malentendants. 
			...
			Cette possibilité peut être utilisée pour traduire : </br>
			* l'accueil et la présentation de l'épreuve,</br>
			* les questions et les réponses relatives aux vérifications,</br>
			* les annonces faites suite aux éventuelles erreurs sérieuses ou graves,</br>
			* le bilan de l'évaluation le cas échéant.</br>
			Durant les épreuves, le candidat peut faire appel notamment à un interprète en langue des signes ou à un codeur 
			en langage parlé complété. La fréquence des sessions théoriques ne peut être inférieure à 2 fois par an.
                   </p>
			<div class="hr"></div>
			<h3>
		    4. Durée de validité du permis<a name="validité" id="validité"></a></h3>
			<p> 
			Le permis est valable :</br>
			* 5 ans s'il est âgé de moins de 60 ans </br>
			* 2 ans entre 60 et 76 ans</br>
			* 1 an après 76 ans </br>
			A l'expiration de la durée de validité, l'intéressé est soumis à une visite médicale. 
			Si le certificat médical est favorable, son permis est prorogé (renouvelé). Exceptionnellement, si le certificat établit 
			que l'infirmité ou l'invalidité est stabilisée, la durée de validité peut ne pas être limitée. En toutes circonstances,
			le titulaire d'un permis adapté au handicap doit conduire un véhicule spécialement aménagé pour tenir compte de son handicap.
			</p>
		</div>				 
