...
<body>
 ...
 if( $result = mysql_fetch_object( $requete ) )
  ...
  <section id="espPerso" class="bloc">
		...
		<div id='cssmenu'>
                <ul>
                  <li><a href='permisB.php' class="current2"><span>Permis B </span></a></li>
       ...
       <a href="code_de_rote.pdf"><img src="images/3801.jpg" alt=""   width="230" height="300" align="left"/></a> 
	    <a href="http://www.preventionroutiere.asso.fr/Espace-multimedia/Tests-Code-de-la-route"><img alt="" src="images/896805111.jpg" width="230" height="300" align="left" class="quiz"></a>
                  ...
                  <div class="imgleft" style="max-width: 100%;width:150px;">
                    <img src="images/permis-auto-permis-B.jpg" alt="" style="width: 100%"/></div>
                        <strong><a href="#principe">1.&nbsp;Principe</a><br />  
				        <a href="#autorisation"> 2.&nbsp;Véhicules pouvant être conduits avec le permis B  </a><br />  
				        <a href="#validiter"> 3.&nbsp;Durée de validité du permis B </a><br />  
				        <a href="#mentions">  4.&nbsp;Mentions figurant sur le permis  </a><br /> 
						<a href="#sanction">5.&nbsp;Sanction en cas de conduite sans permis </a></strong><br />  
			    </div>
			     </div>     
<div id="contenu">
          <h3>
		    1.  Principe <a name="principe" id="principe"></a></h3>
		<p> Le permis B est le permis qui permet de conduire les voitures et qui est nécessaire pour acquérir éventuellement d'autres permis 
		tels que les permis "poids lourds" des catégories C, D et E.</p>
		<div class="hr"></div>
		<h3>
		    2. Véhicules pouvant être conduits avec le permis B   <a name="autorisation" id="autorisation"></a></h3>
			<p> Le permis B permet la conduite : </br>
			* des véhicules dont le PTAC (poids total autorisé en charge) est inférieur ou égal à 3,5 tonnes et pouvant être affecté au transport
			des personnes ou des marchandises,</br>
			*des véhicules pouvant comporter 9 places assises maximum (siège du conducteur compris).</br>
			Aux véhicules de cette catégorie peut être attelée une remorque : </br>
			* dont le PTAC est inférieur ou égal à 750 kilogrammes, </br>
			*dont le PTAC est supérieur à 750 kilogrammes à condition qu'il soit inférieur ou égal au poids à vide du véhicule tracteur, 
			et que la somme des PTAC de l'ensemble soit inférieure ou égale à 3,5 tonnes.</br>
			Si ces PTAC sont dépassés, un permis E(B) doit être obtenu. Une exception à cette règle est faite pour le permis B délivré avant
			le 20 janvier 1975 qui permet de conduire un camping-car de plus de 3,5 tonnes à condition que son titulaire ait fait ajouter 
			le code 79 sur son permis par la préfecture de son lieu de résidence. Il convient de se renseigner auprès des services préfectoraux 
			pour connaître la procédure à suivre.   </br>
			</p>
			<div class="hr"></div>
			<h3>
		    3.  Durée de validité du permis B <a name="validiter" id="validiter"></a></h3>
			<p> Le permis de conduire doit être renouvelé tous les dix ans, sauf pour le permis probatoire (nouveau permis) dont la
              durée de validité est de seulement deux (2) ans.
                   </p>
			<div class="hr"></div>
			<h3>
		    4. Mentions figurant sur le permis<a name="mentions" id="mentions"></a></h3>
			<p> 
...
À noter        : en cas de port de lentilles ou de verres de contact, il est recommandé d'être en possession de lunettes correctrices également dans le véhicule.     
Le fait de conduire un véhicule sans respecter les conditions de validité ou les restrictions d'usage du permis de conduire est puni de l'amende prévue pour les contraventions de 4ème classe et entraîne la perte de 3 points du permis de conduire.</br>
Des peines complémentaires peuvent être prononcées :</br>
* la suspension du permis de conduire, pour une durée de 3 ans au plus, cette suspension pouvant être limitée à la conduite en dehors de l'activité professionnelle,</br>
* l'interdiction de conduire certains véhicules à moteur, y compris ceux pour la conduite desquels le permis de conduire n'est pas exigé, pour une durée de 3 ans au plus,</br>
* l'obligation d'accomplir, à ses frais, un stage de sensibilisation. </br>
			</p>
			<div class="hr"></div>
			<h3>
		    5. Sanction en cas de conduite sans permis <a name="sanction" id="sanction"></a></h3>
			<p> 
			...
			est un délit punissable d'un an d'emprisonnement, de 15.000 DA d'amende et de la peine complémentaire de      
			confiscation obligatoire du véhicule (sauf décision contraire et motivée du juge) si la personne qui a commis l'infraction 
