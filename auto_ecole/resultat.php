...
$reponse = $bdd->query('SELECT * FROM candidats ORDER BY identifiant DESC');
						 ...
						 <article>
						    ...
						    <div class="ajouter">
			                        ...
			                        <form action="" method="POST">
                                       ...
                                       <select name="epreuve" id="epreuve" disabled>
										...
										<label for="resultat"><strong>Résultat D'examen : </strong></label>  
                                            <select name="resultat" id="resultat" disabled >
                                            ...
                                            <select name="examen_payer" id="examen_payer" disabled>
